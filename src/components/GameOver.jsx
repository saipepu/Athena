    ...
    <div className="model_wrapper">
      <div className="gameOver">
        ...
        <div className="btn_gp">
          {win ? (
            <button className="claim_reward" onClick={() => setGameOver(!gameOver)}>Claim Reward</button>
          ): (
            <button className="go_to_home" onClick={() => setGameOver(!gameOver)}>Go to Home</button>
          )}
          <button className="play_again" onClick={() => setGameOver(!gameOver)}>Play Again</button>
        </div>
      </div>
    </div>
  )
